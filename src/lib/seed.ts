  ...
  articles: [
    {
      ...
      body: [
        "Your Global Report app is live and ready. Click the ↻ Refresh Now button above to fetch the latest intelligence briefing across all six domains: Sanctions, Economics, Regions, OCC, Financial Penalties, and BIS/Export Controls.",
