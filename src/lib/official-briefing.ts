...
const SOURCE_SECTION_MAP: Record<string, Section> = {
  ...
  "AP News — Sanctions & Finance":               "sanctions",
  "AP News — World & Economics":                 "economics",
  "AP News — World & Regional":                  "regions",
  "CNN — World & Sanctions":                     "sanctions",
  "CNN — Business & Trade":                      "economics",
...
const SOURCE_CATEGORY_MAP: Record<string, string> = {
  ...
  "AP News — Sanctions & Finance":               "Associated Press",
  "AP News — World & Economics":                 "Associated Press",
  "AP News — World & Regional":                  "Associated Press",
  "CNN — World & Sanctions":                     "CNN",
  "CNN — Business & Trade":                      "CNN",
